...
baseOutDir = 'results/UL2016post/tnpEleID_UL2016post/'
...
if not samplesDef['mcAlt' ] is None: samplesDef['mcAlt' ].set_weight(weightName)
if not samplesDef['tagSel'] is None: samplesDef['tagSel'].set_weight(weightName)
if not samplesDef['mcNom' ] is None: samplesDef['mcNom' ].set_puTree('/afs/cern.ch/work/y/yilai/TNP/CMSSW_10_6_8/src/egm_tnp_analysis/PU/IDISO/UL16post/DY_madgraph_ele.pu.puTree.root')
if not samplesDef['mcAlt' ] is None: samplesDef['mcAlt' ].set_puTree('/afs/cern.ch/work/y/yilai/TNP/CMSSW_10_6_8/src/egm_tnp_analysis/PU/IDISO/UL16post/DY_amcatnloext_ele.pu.puTree.root')
if not samplesDef['tagSel'] is None: samplesDef['tagSel'].set_puTree('/afs/cern.ch/work/y/yilai/TNP/CMSSW_10_6_8/src/egm_tnp_analysis/PU/IDISO/UL16post/DY_madgraph_ele.pu.puTree.root')
...
tnpParAltSigFit = [
    "meanP[-0.0,-10.0,5.0]","sigmaP[1,0.7,6.0]","alphaP[2.0,1.2,3.5]" ,'nP[3,-5,5]',"sigmaP_2[1.5,0.5,6.0]","sosP[1,0.5,5.0]",
    "meanF[-0.0,-5.0,5.0]","sigmaF[2,0.7,15.0]","alphaF[2.0,1.2,3.5]",'nF[3,-5,5]',"sigmaF_2[2.0,0.5,6.0]","sosF[1,0.5,5.0]",
...
#60
tnpParAltSigFit = [
    "meanP[-0.0,-0.0,0.0]","sigmaP[1,1,1.0]","alphaP[3.0,3,3.]" ,'nP[3,-5,5]',"sigmaP_2[4,4,4.0]","sosP[1,1.0,1.0]",
    "meanF[-0.0,-0.0,0.0]","sigmaF[1,1,1.0]","alphaF[3.0,3,3.]",'nF[3,-5,5]',"sigmaF_2[4.0,4,4.0]","sosF[1,1,1.0]",
    "acmsP[90.,90.,90.]","betaP[0.0,0.0,0.0]","gammaP[0., 0.00,0 ]","peakP[90.0]",
    "acmsF[90.,90.,90.]","betaF[0.0,0.0,0.0]","gammaF[0., 0.00, 0]","peakF[90.0]",
    ]
tnpParAltSigFit = [
    "meanP[-0.0,-5.0,5.0]","sigmaP[-1,-6, -0.7]","alphaP[2.0,1.2,3.5]" ,'nP[3,-5,5]',"sigmaP_2[1.5,0.5,6.0]","sosP[1,0.5,5.0]",
    "meanF[-0.0,-5.0,5.0]","sigmaF[-1,-6, -0.7]","alphaF[2.0,1.2,3.5]",'nF[3,-5,5]',"sigmaF_2[2.0,0.5,6.0]","sosF[1,0.5,5.0]",
    "acmsP[60.,50.,75.]","betaP[0.04,0.01,0.06]","gammaP[0.1, 0.005, 1]","peakP[90.0]",
    "acmsF[60.,50.,75.]","betaF[0.04,0.01,0.06]","gammaF[0.1, 0.005, 1]","peakF[90.0]",
    ]
...
tnpParAltSigFit_addGaus = [
    "meanP[-0.0,-5.0,5.0]","sigmaP[1,0.7,6.0]","alphaP[2.0,1.2,3.5]" ,'nP[3,-5,5]',"sigmaP_2[1.5,0.5,6.0]","sosP[1,0.1,5.0]",
    "meanF[-0.0,-5.0,5.0]","sigmaF[1,0.7,6.0]","alphaF[2.0,1.2,3.5]",'nF[3,-5,5]',"sigmaF_2[1.5,0.5,6.0]","sosF[1,0.1,5.0]",
    "meanGF[95.0,60.0,90.0]","sigmaGF[15,5.0,125.0]",
    "acmsP[60.,50.,175.]","betaP[0.04,0.01,0.16]","gammaP[0.1, 0.00, 1]","peakP[90.0]",
    "acmsF[60.,50.,185.]","betaF[0.04,0.01,0.16]","gammaF[0.1, 0.00, 1]","peakF[90.0]",
    ]
