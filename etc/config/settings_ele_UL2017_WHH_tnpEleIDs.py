...
#60
tnpParAltSigFit = [
    "meanP[1.0,-5.0,5.0]","sigmaP[2.1,0.1,6.0]","alphaP[2.0,1.2,3.5]" ,'nP[1,-5,3]',"sigmaP_2[2.1,2,10.0]","sosP[0.3,0.3,0.4]",
    "meanF[1.0,-5.0,5.0]","sigmaF[2.0,0.7,15.0]","alphaF[1.5,1.2,3.5]",'nF[1,-5,3]',"sigmaF_2[2.0,0.5,6.0]","sosF[0.3,0.3,0.4]",
    "acmsP[100.,90.,105.]","betaP[0.04,0.01,0.06]","gammaP[0.1, 0.005, 1]","peakP[90.0]",
    "acmsF[100.,90.,105.]","betaF[0.04,0.01,0.06]","gammaF[0.1, 0.005, 1]","peakF[90.0]",
    ]
...
tnpParAltSigFit_addGaus = [
    "meanP[-0.0,-5.0,5.0]","sigmaP[1,0.7,6.0]","alphaP[2.0,1.2,3.5]" ,'nP[3,-5,5]',"sigmaP_2[1.5,0.5,6.0]","sosP[1,0.1,5.0]",
    "meanF[-0.0,-5.0,5.0]","sigmaF[1,0.7,6.0]","alphaF[2.0,1.2,3.5]",'nF[3,-5,5]',"sigmaF_2[1.5,0.5,6.0]","sosF[1,0.1,5.0]",
    "meanGF[75.0,50.0,90.0]","sigmaGF[15,5.0,125.0]",
    "acmsP[60.,30.,75.]","betaP[0.04,0.01,0.16]","gammaP[0.1, 0.00, 1]","peakP[90.0]",
    "acmsF[60.,30.,85.]","betaF[0.04,0.01,0.16]","gammaF[0.1, 0.00, 1]","peakF[90.0]",
    ]
#63
tnpParAltSigFit_addGaus = [
    "meanP[0.7]","sigmaP[0.76,0.1,6.0]","alphaP[2.3,1.2,3.5]" ,'nP[5]',"sigmaP_2[7.4,0.5,25.0]","sosP[1,0.1,5.0]",
    "meanF[-0.0,-5.0,5.0]","sigmaF[1,0.7,6.0]","alphaF[2.0,1.2,3.5]",'nF[3,-5,5]',"sigmaF_2[1.5,0.5,6.0]","sosF[1,0.1,5.0]",
    "meanGF[110.0,100.0,130.0]","sigmaGF[15,5.0,125.0]",
    "acmsP[60.,30.,75.]","betaP[0.04,0.01,0.16]","gammaP[0.1, 0.00, 1]","peakP[90.0]",
    "acmsF[60.,30.,75.]","betaF[0.04,0.01,0.16]","gammaF[0.1, 0.00, 1]","peakF[90.0]",
    ]
