...
#11
tnpParNomFit = [
    "meanP[-0.85,-5.0,5.0]","sigmaP[2.4,0.5,5.0]",
    "meanF[2.1,-5.0,5.0]","sigmaF[6,0.5,15.0]",
    "acmsP[60.,50.,80.]","betaP[0.05,0.001,0.18]","gammaP[-0.1, -2, 2]","peakP[90.0]",
    "acmsF[60.,20.,80.]","betaF[0.01,0.001,0.08]","gammaF[0.03, -2, 2]","peakF[90.0]",
    ]

#09
tnpParNomFit = [
    "meanP[-0.85,-5.0,5.0]","sigmaP[2.4,0.5,5.0]",
    "meanF[2.1,-10.0,5.0]","sigmaF[6,0.5,15.0]",
    "acmsP[60.,50.,80.]","betaP[0.05,0.001,0.18]","gammaP[-0.1, 0.01, 2]","peakP[90.0]",
    "acmsF[60.,20.,70.]","betaF[0.01,0.00,0.08]","gammaF[0.03, 0.001, 5]","peakF[90.0]",
    ]
...
# 68
tnpParAltSigFit = [
    "meanP[-0.0,-5.0,5.0]","sigmaP[1,0.7,6.0]","alphaP[1.7,1.2,3.5]" ,'nP[0.9,-5,5]',"sigmaP_2[1.5,0.5,6.0]","sosP[1,0.5,5.0]",
    "meanF[-0.0,-5.0,5.0]","sigmaF[2,0.7,15.0]","alphaF[2.0,1.2,3.5]",'nF[0.3,-5,5]',"sigmaF_2[2.0,0.5,6.0]","sosF[1,0.5,5.0]",
